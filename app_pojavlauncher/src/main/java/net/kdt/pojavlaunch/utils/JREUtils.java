...
public class JREUtils {
    ...
    public static void setJavaEnvironment(Activity activity, String jreHome) throws Throwable {
        ...
        // Fix white color on banner and sheep, since  1.1.5
    ...
    public static String loadGraphicsLibrary(){
        ...
        switch (LOCAL_RENDERER){
            ...
            case "opengles3_2_fogltlogles" : renderLibrary = "libFOGLTLOGLES.so"; break;
            case "opengles3_2_ng_gl4es" : renderLibrary = "libng_gl4es.so"; break;
            default:
